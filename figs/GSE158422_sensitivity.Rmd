...
boxplot(dots,names=SAMPLESIZES,col="white",ylab="no. true positives",xlab="sample size",cex=0)
...
ratio <- t(TPdots/FPdots)
ratio <- lapply(1:ncol(ratio),function(i) {ratio[,i]})

boxplot(ratio,names=SAMPLESIZES,col="white",ylab="TP per FP",xlab="sample size",cex=0)
...
Individual probes have a distribution that leans positive, but after aggregation to genes it is actually
negative.
