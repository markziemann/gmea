...
Using the S and B datasets separately, apply limma to conduct differential methylation analysis,
then GMEA.
GMEA has two steps:
...
split_analyse <- function(seed){
  ...
  return(list("ssig"=ssig,"bsig"=bsig))
}
