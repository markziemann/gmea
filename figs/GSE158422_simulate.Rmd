...
incorp_dm <- function(genesetdatabase,myann,gene_catalog,mval,seed,frac_genes,frac_probes) {
...
sim <- incorp_dm(genesetdatabase=gs_symbols,myann=myann,gene_catalog=gene_catalog,
  mval=normal_mval,seed=100,frac_genes=0.5,frac_probes=0.5) 
