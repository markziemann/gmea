...
```{r,summary,fig.width=12,fig.height=3}
...
barplot(t(x),beside=TRUE,ylim=c(0,1),ylab="index", col=cols, main="20 genes per set")
grid()

legend("topleft", inset=.1, c("Precision","Recall","F1"), fill=cols, cex=0.8)
...
barplot(t(x),beside=TRUE,ylim=c(0,1),ylab="index", col=cols, main="50 genes per set")
grid()
...
barplot(t(x),beside=TRUE,ylim=c(0,1),ylab="index", col=cols, main="100 genes per set")
grid()
