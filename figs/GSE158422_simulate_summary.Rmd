...
```{r,summary,fig.width=10,fig.height=4}
...
barplot(t(x),beside=TRUE,ylim=c(0,1.2),ylab="index", legend = colnames(x) ,main="20 genes per set")
grid()
...
barplot(t(x),beside=TRUE,ylim=c(0,1.2),ylab="index", legend = colnames(x) ,main="50 genes per set")
grid()
...
barplot(t(x),beside=TRUE,ylim=c(0,1.2),ylab="index", legend = colnames(x) ,main="100 genes per set")
grid()
