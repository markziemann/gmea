...
l <- list("GSA"=gres2,"LAT"=lacres2,"LTT"=lactopres2,"LAW"=nlacres2,
  "LAM"=lacmres2,"ALT"=alcres2,"ALW"=nalcres2,"ALM"=almres2)

x <- do.call(rbind,lapply(l,summarise))

x %>% kbl(caption="sim 20 res") %>% kable_paper("hover", full_width = F)

cols <- c("white","gray","black")

barplot(t(x),beside=TRUE,ylim=c(0,1),ylab="index", col=cols, cex.names=0.7, cex.axis=0.7, main="20 genes per set")
grid()
...
x %>% kbl(caption="sim 50 res") %>% kable_paper("hover", full_width = F)

barplot(t(x),beside=TRUE,ylim=c(0,1),ylab="index", col=cols, cex.names=0.7, cex.axis=0.7, main="50 genes per set")
grid()
...
x %>% kbl(caption="sim 100 res") %>% kable_paper("hover", full_width = F)

barplot(t(x),beside=TRUE,ylim=c(0,1),ylab="index", col=cols, cex.names=0.7, cex.axis=0.7, main="100 genes per set")
grid()
