...
p3 <- heatmap.2( as.matrix(mtop) , trace="none",margins = c(6,25), col=colfunc(25), cexRow=.6, cexCol=1)
...
p1 <- plot(euler(vg),quantities=TRUE)
...
p2 <- plot(euler(vm),quantities=TRUE)
...
plot5 <- grid.arrange(arrangeGrob(p1, p2, ncol=1), p3,
  ncol=2, widths=c(1,1))
