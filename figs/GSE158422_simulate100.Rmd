...
gene_catalog <- unique(unlist(strsplit(myann$GencodeCompV12_NAME,";")))
...
incorp_dm <- function(genesets,myann,mval,seed,
  ...
  probe2gene <- strsplit(myann$GencodeCompV12_NAME,";")
...
magg <- function(mval,myann,cores=1){
  gn <- unique(unlist(strsplit( myann$GencodeCompV12_NAME ,";")))
  gnl <- strsplit( myann$GencodeCompV12_NAME ,";")
  gnl <- mclapply(gnl,unique,mc.cores=cores)
  myann$gnl <- gnl
  keep <- rownames(subset(myann,GencodeCompV12_NAME!=""))
