...
# DM3 - post trial supplement versus placebo
...
mitch_report(res,outfile="dma3a_mitch.html",overwrite=TRUE)
...
mitch_report(res,outfile="dma3a_mitch_promo.html",overwrite=TRUE)
