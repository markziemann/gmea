...
Enrichment results were then filtered for FDR<0.05 and the correct direction of methylation change.
...
dataset, followed by an update of gene symbols with HGNChelper.
...
Updating defunct gene symbols is an important step as 2,788 and 3,253 gene symbols were updated on the HM450K and EPIC array annotations, which represent approximately 10-14% of genes on these platforms.
