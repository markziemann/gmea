...
The differential methylation of probes belonging to each gene are scored and these gene scores
...
In this method, all probe measurements belonging to each gene are averaged before conducting differential
methylation analysis with limma.
...
Raw intensity files (IDAT format) were read into R with minfi [@Aryee2014-su], normalisation was conducted with the SWAN method
...
There is also potential to generate new libraries of differentially methylated probes and gene sets, to contribute to the pool of molecular signatures in public resources like MSigDB,
