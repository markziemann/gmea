...
HGNChelper was used to fix gene names converted to dates, followed by DESeq2 based differential analysis.
...
EPIC methylation profile associations with age of two independent cohorts involving a total of 7036
...
with a condition.
Therefore, we examined differential pathway methylation associated with incidence of 19 disease states.
...
An interesting observation is that ORA performed better when gene sets are smaller in our simulations.
...
The differences in pathway results obtained with LAM and GSA from lung cancer data were striking, not only in the numbers of
pathways identified, but also their relevance to the disease.
...
Joint enrichment analysis showed some genes with increasing promoter methylation together with increasing RNA expression
(eg: “Negative regulation of AP2 transcription factors”).
...
This work could be extended to include not just proximal CpG sites, but also enhancer-based probes and their target genes based on resources such as GeneHancer [@Fishilevich2017-xx].
