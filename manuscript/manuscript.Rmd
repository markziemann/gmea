...
![Figure 1. Precision, recall and F1 for enrichment tests with simulated data.](../figs/fig1.png)
...
![Figure 2. Precision, recall and F1 for GSA and LAM enrichment tests over a range of group sizes and delta values. One hundred genes per set.](../figs/fig2.png)

### Sensitivity of GSA and LAM methods with real cancer data

Next, GSA and LAM methods were applied to compare paired normal and cancer methylation data.

* Chart results with 37 pax.

* Show sensitivity analysis with range of samples from 3 to 30.


* LAM has better performance than GSAmeth

* Could be due to (1) filtering genes without annotations, and (2) FDR not applied for sets without members.

* Can make changes to the GSAmeth codes to fix the problems.
