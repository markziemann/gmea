...
(https://hub.docker.com/repository/docker/mziemann/gmea/general), and an example workflow can be found
in the GitHub repository (https://github.com/markziemann/gmea/tree/main/example_workflow).
