...
set of genes has distribution of scores that is different to the null [@Subramanian2005-ar].

The `gsameth()` function of the `missMethyl` package is the state-of-the-art methods for ORA of infinium methylation array
...
FCS methods `ebGSEA` and `methylGSA` have been applied to EWAS data and are suggested to have better sensitivity to
...
Here we aim to develop and evaluate methods for two-tailed FCS of Infinium methylation array data that reports enrichment
scores.
