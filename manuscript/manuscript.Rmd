...
Given GSA found relatively few results

Considering the number of significant probes was very large we were concerned that
...
To compare the sensitivity of these methods, sample sizes were randomly downsampled, analysed
...
* Separate promoter and gene body integration
