...
Secondly, `methylglm` uses a logistic regression approach to model differential methylation for genes inside and outside eachgene set [@Ren2019-mr].
...
The first set of methods use differential probe methylation data as an input.
