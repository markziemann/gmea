...
At 20 genes per set, GSA had the highest overall performance, with F1 of 0.25, followed by LAW with 0.06.
At 50 genes per set, GSA and LAM achieved similar F1 values of ~0.39.
...
Performance results for GSA and LAM methods with 100 genes per set shows that recall was higher for most
simulations, particularly with lower group sizes.
